...
import { RecipeSlugWrapper } from './components/RecipeSlugWrapper';
import { CategorySlugWrapper } from './components/CategorySlugWrapper';
import { initAnalytics, trackPageView } from './utils/analytics'; // NEW IMPORT
...
export const App: React.FC = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        // Init Analytics globally after loading settings
        if (loadedSettings.googleAnalyticsId || loadedSettings.metaPixelId) {
  ...
  const setView = (newView: string) => {
    switch (newView) {
      ...
      case 'all-recipes': navigate('/receitas'); break;
      case 'web-stories': navigate('/stories'); break;
      case 'favorites': navigate('/favoritos'); break;
      case 'all-categories': navigate('/categorias'); break;
      case 'meal-plans': navigate('/planos'); break;
      case 'detail':
      case 'category':
        break;
    }
