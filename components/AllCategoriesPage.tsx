...
export const AllCategoriesPage: React.FC<AllCategoriesPageProps> = ({ 
  ...
  return (
    <div className="min-h-screen bg-white animate-fade-in pb-20">
      <Helmet>
        <title>Categorias - Receita Popular</title>
        <meta name="description" content="Explore todas as categorias de receitas e descubra novos sabores todos os dias." />
        <meta property="og:title" content="Explorar Categorias - Receita Popular" />
        <meta property="og:description" content="Navegue pelas melhores categorias gastronômicas e encontre sua próxima refeição." />
