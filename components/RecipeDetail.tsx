    ...
    <div className="bg-white min-h-screen animate-fade-in pb-20 relative">
      ...
      <div className="bg-white">
        <div className="max-w-4xl mx-auto px-4 pt-8 md:pt-12 pb-8 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 md:gap-6 lg:gap-8 mt-8 md:mt-10 pt-8 md:pt-10 border-t border-gray-100">
            {/* Meta Stats */}
            ...
            <div className="hidden md:block w-px h-10 bg-gray-200"></div>
             <div className="flex items-center gap-3">
               ...
               <div className="text-left">
                  <div className="text-[9px] md:text-[10px] font-bold text-gray-400 uppercase tracking-widest">Acessos</div>
                  <div className="text-pop-dark font-bold font-serif text-sm md:text-lg leading-none mt-0.5">
                     {/* Pseudo-random deterministic view count based on string chars */}
                     {Math.floor(Array.from(currentRecipe.id).reduce((acc, char) => acc + char.charCodeAt(0), 0) * 11.7 + 1024).toLocaleString('pt-BR')}
                  </div>
               </div>
            </div>
          </div>
